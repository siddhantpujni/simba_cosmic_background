...
Current implementation does only massive star formation which is greater than 5 solar masses, there is no AGN jets modelled yet which \cite{thomasRadioGalaxyPopulation2021} does analyse and discuss in the paper.
...
\begin{equation}
    \frac{P_\mathrm{Rad}}{10^{30}\mathrm{erg}\text{ }\mathrm{s^{-1}}} = \frac{\dot{M}_{BH}}{4\times10^{17}\mathrm{g}\text{ }\mathrm{s^{-1}}}
