...
plot the dust temp plot from diagnostics with the fitting and the spread. get median temp but there is some spread and there is a variance of so and so and its on the galaxy thing and not for the background itself. but the median is this and we get lower too cause spread at higher z more temp so its higher cause of sf, and cite that paper i sent romeel. do dust and then 3 sigma each side to show the spread with the variance of the T
