...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/week 1/mass_diss.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/week 1/galaxy_sed.png}
...
Need to add more references and papers and stuff.
