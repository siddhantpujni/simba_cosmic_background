...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/week_2/abs_mag_sed_stellar_mass_bins.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/week_2/app_mag_sed_stellar_mass_bins.png}
